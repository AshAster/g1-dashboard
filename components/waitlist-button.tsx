...
import './waitlist-button.css';

export function WaitlistButton({ isSent = false }: { isSent?: boolean }) {
  return (
    <div className="wb-wrapper">
      <button type="submit" className={`wb-button ${isSent ? 'is-sent' : ''}`}>
        <div className="wb-outline" />
        <div className="wb-state wb-state--default">
        ...
        <div className="wb-state wb-state--sent">
          <div className="wb-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="1em" width="1em" strokeWidth="0.5px" stroke="black">
              <g style={{ filter: 'url(#shadow)' }}>
                ...
                <path fill="currentColor" d="M10.5795 15.5801C10.3795 15.5801 10.1895 15.5001 10.0495 15.3601L7.21945 12.5301C6.92945 12.2401 6.92945 11.7601 7.21945 11.4701C7.50945 11.1801 7.98945 11.1801 8.27945 11.4701L10.5795 13.7701L15.7195 8.6301C10.0095 8.3401 16.4895 8.3401 16.7795 8.6301C17.0695 8.9201 17.0695 9.4001 16.7795 9.6901L11.1095 15.3601C10.9695 15.5001 10.7795 15.5801 10.5795 15.5801Z" />
              </g>
            </svg>
          </div>
          <p>
