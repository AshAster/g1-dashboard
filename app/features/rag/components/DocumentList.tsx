      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-border bg-secondary/20">
            ...
            <th className="hidden sm:table-cell py-4 px-4 text-xs font-mono uppercase tracking-wider text-muted-foreground font-normal whitespace-nowrap">Type</th>
            <th className="hidden md:table-cell py-4 px-4 text-xs font-mono uppercase tracking-wider text-muted-foreground font-normal whitespace-nowrap">Size</th>
        ...
        <tbody className="divide-y divide-border">
          {documents.map((doc) => (
            <tr key={doc.id} className="group hover:bg-secondary/10 transition-colors">
              <td className="py-4 px-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-mono text-muted-foreground mt-0.5">Uploaded {doc.uploadedAt}</p>
                  </div>
                </div>
              </td>
              ...
              <td className="hidden md:table-cell py-4 px-4 text-sm font-mono whitespace-nowrap">{doc.size}</td>
              ...
              <td className="py-4 px-4 text-right whitespace-nowrap">
                <div className="flex items-center justify-end gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                  ...
                  <button onClick={() => onDelete(doc.id)} className="p-2 text-muted-foreground hover:text-destructive transition-colors" title="Delete">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
